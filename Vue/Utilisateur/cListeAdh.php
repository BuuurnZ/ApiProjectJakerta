            ...
            foreach ($lesEleves as $eleve) {?>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <div class="mt-4 mr-0 mb-0 ml-0 pt-0 pr-0 pb-0 pl-14 flex items-center sm:space-x-6 sm:pl-0 sm:mt-0">
                        <a class="flex items-center bg-yellow-500 h-12 px-3 mt-2 rounded hover:bg-yellow-600" href="index.php?uc=utilisateur&action=modifier&idutilisateur=<?php echo($eleve->getIdutilisateur()) ?>">
                    ...
                    <td class="px-6 py-4">
                        <div class="mt-4 mr-0 mb-0 ml-0 pt-0 pr-0 pb-0 pl-14 flex items-center sm:space-x-6 sm:pl-0 sm:mt-0">
                            ...
                            <a class="flex items-center bg-red-600 h-12 px-3 mt-2 rounded hover:bg-gray-300" href="index.php?uc=utilisateur&action=supprimer&idutilisateur=<?php echo($eleve->getIdutilisateur()) ?>">
