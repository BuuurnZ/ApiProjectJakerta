...
<section class="bg-cover bg-center min-h-screen overflow-hidden p-12 bg-violet-600" style="background-image: url('Images/music.jpg');">
    ...
    <div class="sm:ml-40">
        ...
        <form id="ajoutEleve" class="mt-8 sm:mt-0 md:mt-0 lg:mt-0 ml-4 sm:ml-8 md:ml-16 lg:ml-24 max-w-lg" action="index.php?uc=classe&action=modifierClasse" method="post">
            <?php if(isset($lesEleves) && $lesEleves != NULL): ?>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center space-x-6">
                                                ...
                                                <input type="checkbox" id="eleve<?= $eleve->getIDELEVE() ?>" name="eleves[]" value="<?= $eleve->getIDELEVE() ?>" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" <?php foreach ($elevesDansLaClasse as $eleveDansClasse):  if($eleve->getIDELEVE() == $eleveDansClasse->getIDELEVE()){echo('checked');} endforeach; ?>>
                ...
                <input type="hidden" id="idclasse" name="idclasse" value="<?= $idClasse ?>">
