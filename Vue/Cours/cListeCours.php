                ...
                <tr class="bg-white border-b ">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <div class="pl-3">
                                    ...
                                    <div class="font-normal text-gray-500">Professeur: <?= $cours->getNomProfesseur() ?> <?=$cours->getPrenomProfesseur()?> </div>
                                </div>  
                            </th>
                            <td class="px-6 py-4">
                                <?= htmlspecialchars($cours->getdate()) ?> 
                            </td>
                            <td class="px-6 py-4">
                                <?= htmlspecialchars($cours->getHeureDebut()) ?> 
                            </td>
                            <td class="px-6 py-4">
                                <?= htmlspecialchars($cours->getHeureFin()) ?>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <div class="mt-4 mr-0 mb-0 ml-0 pt-0 pr-0 pb-0 pl-14 flex items-center sm:space-x-6 sm:pl-0 sm:mt-0">
                                    <a class="flex items-center bg-yellow-500 h-12 px-3 mt-2 rounded hover:bg-yellow-600" href="index.php?uc=inscriptions&action=liste&idprof='. $cours->IDPROF .'&nums='. $cours->NUMSEANCE .'&jour='. $cours->JOUR .'&tranche='. $cours->TRANCHE .'">
